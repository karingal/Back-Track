...
public class BTree<T extends Comparable<T>> {
    ...
    protected Deque<Object> backTrackDeque = new ArrayDeque <>(); // A Deque to keep in it the relvant data for backtracking
    ...
    public void insert(T value) {
    	backTrackDeque.addFirst("Done"); // Adding "Done" marker to the deque
        if (root == null) {
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                	...
                	if(currentNode==root) { // An indicator for the root
                		backTrackDeque.addFirst("I am root");
                	}
                	backTrackDeque.addFirst(currentNode); 
        ...
        backTrackDeque.addFirst(value); // Adding the inserted value to the deque
        ++size;
